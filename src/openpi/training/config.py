...
class TrainConfig:
    ...
    # Optional interval for grouped gradient logging. If None, defaults to log_interval.
    grouped_grad_log_interval: int | None = None
...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi05_libero_torch_debug", # torch
    ...
    TrainConfig(
        name="libero10_pi05ki_alltasks_official", # 从openpi jax转的pi05_base训练
        project_name="pi05_research",
        model=pi0_config.Pi0Config(
            pi05_ki=True,
            action_horizon=10,
    ...
    TrainConfig(
        name="libero10_pi05ki_alltasks_official_no_fast",
        project_name="pi05_research",
        model=pi0_config.Pi0Config(
            pi05_ki=True,
            action_horizon=10,
            enable_fast_loss=False,
            enable_subtask_loss=True,
            enable_ki_attention=True,
            fast_model_tokenizer_kwargs={"fast_tokenizer_path": "/workspace/data/pi_models/fast-action-tokenizer"},
        ),
        data=LeRobotLiberoSubtaskDataConfig(
            repo_id="/workspace/data/libero/libero_10_subtasks_fixed",
    ...
    TrainConfig(
        name="libero10_pi05ki_alltasks_official_no_subtask",
        project_name="pi05_research",
        model=pi0_config.Pi0Config(
            pi05_ki=True,
            action_horizon=10,
            enable_fast_loss=True,
            enable_subtask_loss=False,
            enable_ki_attention=True,
            fast_model_tokenizer_kwargs={"fast_tokenizer_path": "/workspace/data/pi_models/fast-action-tokenizer"},
        ),
        data=LeRobotLiberoSubtaskDataConfig(
    ...
    TrainConfig(
        name="libero10_pi05ki_alltasks_official_no_ki",
        project_name="pi05_research",
        model=pi0_config.Pi0Config(
            pi05_ki=True,
            action_horizon=10,
    ...
    TrainConfig(
        name="libero10_pi05ki_ablate_subtask_only",
        project_name="pi05_research",
        model=pi0_config.Pi0Config(
            pi05_ki=True,
            action_horizon=10,
    ...
    TrainConfig(
        name="libero10_pi05ki_ablate_fast_only",
        project_name="pi05_research",
        model=pi0_config.Pi0Config(
            pi05_ki=True,
            action_horizon=10,
    ...
    TrainConfig(
        name="libero10_pi05ki_ablate_ar_only_ki_off",
        project_name="pi05_research",
        model=pi0_config.Pi0Config(
            pi05_ki=True,
            action_horizon=10,
    ...
    TrainConfig(
        name="libero10_pi05ki_ablate_flow_only",
        project_name="pi05_research",
        model=pi0_config.Pi0Config(
            pi05_ki=True,
            action_horizon=10,
    ...
    TrainConfig(
        name="libero10_pi05ki_ablate_flow_only_ki_off",
        project_name="pi05_research",
        model=pi0_config.Pi0Config(
            pi05_ki=True,
            action_horizon=10,
    ...
    TrainConfig(
        name="libero10_pi05_alltasks_official", # 从openpi jax转的pi05_base训练
        project_name="pi05_research",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
    ...
    TrainConfig(
        ...
        data=LeRobotLiberoSubtaskDataConfig(
            ...
            base_config=DataConfig(
                prompt_from_task=True,
                tasks=["turn on the stove and put the moka pot on it"],
            ),
            extra_delta_transform=False,
        ),
        batch_size=8*2,
